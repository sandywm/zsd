...
/**
 * StudyAllTjInfo entity. @author MyEclipse Persistence Tools
 */

public class StudyAllTjInfo implements java.io.Serializable {
	...
	/** default constructor */
	public StudyAllTjInfo() {
	}

	/** full constructor */
	public StudyAllTjInfo(Subject subject, Integer liaojieTotalNum,
