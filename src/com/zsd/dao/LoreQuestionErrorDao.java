...
public interface LoreQuestionErrorDao {
	 ...
	 * @return
	 */
	List<LoreQuestionErrorInfo> findPageInfoByOpt(Session sess,Integer userId,Integer lqId,String errorType,String sDate,String eDate,
			Integer updateStatus,Integer pageNo,Integer pageSize);
	 ...
	 * @return
	 */
	Integer getCountByOpt(Session sess,Integer userId,Integer lqId,String errorType,String sDate,String eDate,Integer updateStatus);
}
